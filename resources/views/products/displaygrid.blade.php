...
<div style="padding-top:7%" class="container-fluid"> 
    <nav class="navbar navbar-default navbar-fixed-top"> 
		...
		<ul class="nav navbar-nav">
                    <li><a href="{{ route('members.index') }}">Home</a></li>
					...
					<li><a href="http://localhost:8000/products/displaygrid">Guest Rooms</a></li>
					<li><a href="http://localhost:8000/calendar/display">Event Calendar</a></li>
                </ul>
