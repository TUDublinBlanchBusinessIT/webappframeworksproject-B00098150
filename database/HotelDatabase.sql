...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`courtid`) REFERENCES `court` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

-- Data exporting was unselected.
-- Dumping structure for table hotel.court
...
-- Data exporting was unselected.
-- Dumping structure for table hotel.member
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  CONSTRAINT `member_ibfk_1` FOREIGN KEY (`membertype`) REFERENCES `membershiptype` (`membershiptype`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

-- Data exporting was unselected.
-- Dumping structure for table hotel.membershiptype
DROP TABLE IF EXISTS `membershiptype`;
CREATE TABLE IF NOT EXISTS `membershiptype` (
  `membershiptype` varchar(30) NOT NULL DEFAULT '',
  `courthourlyfee` decimal(18,3) DEFAULT NULL,
  PRIMARY KEY (`membershiptype`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Data exporting was unselected.

-- Dumping database structure for hotel1
DROP DATABASE IF EXISTS `hotel1`;
CREATE DATABASE IF NOT EXISTS `hotel1` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `hotel1`;

-- Dumping structure for table hotel1.booking
DROP TABLE IF EXISTS `booking`;
CREATE TABLE IF NOT EXISTS `booking` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `firstname` varchar(30) DEFAULT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.customer
DROP TABLE IF EXISTS `customer`;
CREATE TABLE IF NOT EXISTS `customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `firstname` varchar(30) DEFAULT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.event
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.member
DROP TABLE IF EXISTS `member`;
CREATE TABLE IF NOT EXISTS `member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `firstname` varchar(30) DEFAULT NULL,
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.migrations
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.orderdetail
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.product
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.scorder
...
-- Data exporting was unselected.
-- Dumping structure for table hotel1.users
